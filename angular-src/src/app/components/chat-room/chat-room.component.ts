...
export class ChatRoomComponent implements OnInit, OnDestroy {
  ...
  constructor( public route: ActivatedRoute, public router: Router, public formBuilder: FormBuilder, public el: ElementRef, public authService: AuthService, public chatService: ChatService ) {}
